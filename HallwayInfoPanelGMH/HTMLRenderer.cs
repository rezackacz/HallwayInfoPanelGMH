...
namespace HallwayInfoPanelGMH {
  class HTMLRenderer {
    ...
    private const string CSS = "@font-face{ font-family: 7segment; src: url(7segment.ttf);} body { font-family: sans-serif; font-size: 4vw;} .table-container { display: table; flex-direction: column; align-items: center; margin-top: 5px; width: 100%} .table-row { display: table-row; justify-content: space-between; width: 100%; border-bottom: 1px solid #ccc; padding: 10px 0;} .title { text-align:center; font-weight:bold} .meal-description { text-align: right; flex-grow:1; max-width: 80%; } .subject {text-align:center; min-width: 6%;} #hodiny { position: absolute; bottom: 0; right: 0; font-size: 10vw; font-family: monospace; font-weight: bold;} .table-cell { display: table-cell; border-bottom: 2px solid } .menu-container { display: flex; flex-direction: column; align-items: center; margin-top: 5px;} .menu-row { display: flex; justify-content: space-between; width: 100%; border-bottom: 1px solid #ccc; padding: 10px 0;}";
