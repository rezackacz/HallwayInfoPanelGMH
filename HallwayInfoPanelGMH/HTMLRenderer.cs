...
namespace HallwayInfoPanelGMH {
  class HTMLRenderer {
    ...
    private const string CSS = "body { font-family: sans-serif; font-size: 3.5vw;} .table-container { display: flex; flex-direction: column; align-items: center; margin-top: 5px;} .table-row { display: flex; justify-content: space-between; width: 100%; border-bottom: 1px solid #ccc; padding: 10px 0;} .title { text-align:center; font-weight:bold} .meal-description { text-align: right; flex-grow:1; max-width: 80%; } .subject {text-align:center; min-width: 6%;} #hodiny { position: absolute; top: 0; right: 0; font-size: 5vw; font-family: monospace;}";
