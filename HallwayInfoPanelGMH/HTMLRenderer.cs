...
namespace HallwayInfoPanelGMH {
  class HTMLRenderer {
    ...
    private const string CSS = "body { font-family: monospace; font-size: 3.5vw;} .table-container { display: flex; flex-direction: column; align-items: center; margin-top: 5px;} .table-row { display: flex; justify-content: space-evenly; width: 100%; border-bottom: 1px solid #ccc; padding: 10px 0;} .title { text-align:center; font-weight:bold}";
